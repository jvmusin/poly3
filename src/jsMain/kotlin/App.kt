    ...
    if (activeProblem != null) {
        ...
        if (activePackage != null) {
            styledA {
                ...
                +"А теперь нажми сюда, чтобы скачать архив для бакса. Замечательно, правда? А если кто-нибудь (Артём) запилит заливку архивов в сайбон, будет вообще чудесно(, Артём)"
                attrs {
