...
object SybonArchiveBuilder {

    private const val BUILT_PACKAGES_FOLDER = "ready"

    private fun build(problem: IRProblem, properties: AdditionalProblemProperties): Path {
        ...
        val zipPath = Paths.get(BUILT_PACKAGES_FOLDER, "${parent.fileName}.zip")
        parent.toZipArchive(zipPath)
        return zipPath
    }

    fun IRProblem.toZipArchive(properties: AdditionalProblemProperties = AdditionalProblemProperties()) =
